  ...
  <div class="row justify-content-center">
    <div class="col-md-6 col-lg-5">
      <div class="card rounded-4 shadow-sm p-4">
        <div class="mb-4">
          <h3 class="fw-bold">✏ Edit Pelanggan</h3>
          <p class="text-muted">Perbarui informasi pelanggan yang terdaftar.</p>
        </div>
        <form method="POST" novalidate>
          ...
          <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-8">
              <input type="text" name="no_hp" id="no_hp" class="form-control rounded-3" value="<?= htmlspecialchars($data['no_hp']) ?>" required>
          ...
          <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-8">
              <input type="text" name="no_ktp" id="no_ktp" class="form-control rounded-3" value="<?= htmlspecialchars($data['no_ktp']) ?>" required>
          ...
          <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-8">
              <textarea name="alamat" id="alamat" class="form-control rounded-3" rows="3" required><?= htmlspecialchars($data['alamat']) ?></textarea>
          ...
          <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-8">
              <input type="text" name="email" id="email" class="form-control rounded-3" value="<?= htmlspecialchars($data['email']) ?>" required>
          ...
          <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-8">
              <input type="date" name="tgl_beli" id="tgl_beli" class="form-control rounded-3" value="<?= htmlspecialchars($data['tgl_beli']) ?>" required>
          ...
          <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-8">
              <textarea name="keterangan" id="keterangan" class="form-control rounded-3" rows="3" required><?= htmlspecialchars($data['keterangan']) ?></textarea>
